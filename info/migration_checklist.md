...
- [ ] Read and analyze Pine script:
  - [ ] Read `/data/S_03 Reversal_v07 Light for Migration.pine`
...
- [ ] **CLI Test:**
  ```bash
  # S_01
  python src/run_backtest.py --csv data/"OKX_LINKUSDT.P, 15 2025.05.01-2025.11.20.csv" --strategy s01_trailing_ma
  
  # S_03
  python src/run_backtest.py --csv data/"OKX_LINKUSDT.P, 15 2025.05.01-2025.11.20.csv" --strategy s03_reversal
  ```
