...
SELECTED_METRIC_OWNERS = {
    ...
    "sharpe_daily": (AdvancedMetrics, "sharpe_daily"),
    "sharpe_daily_observations": (AdvancedMetrics, "sharpe_daily_observations"),
    "sharpe_daily_active_days": (AdvancedMetrics, "sharpe_daily_active_days"),
